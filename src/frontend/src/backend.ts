...
export class Backend implements backendInterface {
    ...
    async getAllMessages(): Promise<Array<InspirationalMessage>> {
        if (this.processError) {
            try {
    ...
    async getAppMotto(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getAppMotto();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDailyMessage(): Promise<InspirationalMessage> {
        if (this.processError) {
            try {
                const result = await this.actor.getDailyMessage();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMessageByCategory(arg0: string): Promise<Array<InspirationalMessage>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMessageByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadBackgroundMusic(arg0: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadBackgroundMusic(await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
