...
export class Backend implements backendInterface {
    ...
    async getAllStreaksNonEmpty(): Promise<Array<[Principal, bigint]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllStreaksNonEmpty();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDailyMessages(): Promise<Array<DailyMessage>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDailyMessages();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateDailyTracker(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.updateDailyTracker();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadBackgroundMusic(arg0: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadBackgroundMusic(await to_candid_ExternalBlob_n13(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
